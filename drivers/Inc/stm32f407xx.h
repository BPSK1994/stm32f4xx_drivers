...
#define FLASH_BASEADDR          0x80000000U       /* Explaining the macro */
#define SRAM1_BASEADDR			0x20000000U       /* Explaining the macro */
#define SRAM2_BASEADDR          0x2001C000U       /* Explaining the macro */
#define ROM_BASEADDR            0x1FFF0000U       /* Explaining the macro */
#define SRAM_BASEADDR           SRAM1_BASEADDR    /* Explaining the macro */
...
typedef struct {
	...
	__vo uint32_t AFR[2];      /*GPIO alternate function register array*/    /*Address offset: 0x20 - 0x24*/
	}GPIO_RegDef_t;
...
/*********************Peripheral registers definition structure for SYSCFG**********************/
...
/*********************Peripheral registers definition structure for SPI**********************/
